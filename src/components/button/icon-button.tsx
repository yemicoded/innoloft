...
interface IIconButton extends React.ComponentProps<"button"> {
  ...
  href?: string;
  variant: "primary" | "secondary" | "none" | "white";
  disabled?: boolean;
  isLoading?: boolean;
  rounded?: boolean;
}
...
const IconButton: React.FC<IIconButton> = ({
  ...
  const classes = classNames(
    "flex items-center justify-center rounded-[4px] min-w-[40px] min-h-[40px] duration-300 overflow-hidden",
    {
      "bg-primary text-white hover:bg-primary/95": variant === "primary",
    },
    {
      "bg-white text-primary hover:bg-gray-300": variant === "white",
    },
    {
